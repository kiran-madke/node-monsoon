var text = [
    ...
    {
        "boxId": "9",
        "infoText": "<table class=\"table\"> <col style=\"width:33.33%\"><col style=\width:33.33%\"><col style=\"width:33.33%\"><tr><td style=\"border: 1px solid #000000;\"><b>2nd(imaging)stress test <br/> (if not done before)<sup>f</sup></b></td><td style=\"border: 1px solid #000000;\"><b>Coronary CTA in suitable patient<sup>d</sup> <br/>  (if not done before)<sup>e</sup> </b></td> <td style=\"border: 1px solid #000000;\"><b>ICA (with FFR when necessary) </b></td></tr></table>",
	...
	"staticImageName": "interactive_0000314",
