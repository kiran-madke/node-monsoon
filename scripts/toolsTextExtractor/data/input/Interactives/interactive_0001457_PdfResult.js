...
function getToolResult() {
    ...
    if (getDataFromOptionsId("classified") == "Fontaine") {
        ResultJson["output"].length = 1;
    }

    if (getDataFromOptionsId("classified") == "Rutherford") {
        ResultJson["output"][0] = ResultJson["output"][1];
        ResultJson["output"][1] = ResultJson["output"][2];
        ResultJson["output"].length = 2;
    }
